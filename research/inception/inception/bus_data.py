...
class BusData(Dataset):
  """Bus data set."""

  def __init__(self, subset):
    super(BusData, self).__init__('Bus', subset)
  ...
  def download_message(self):
    """Instruction to download and extract the tarball from Bus website."""

    print('Failed to find any Bus %s files'% self.subset)
    print('')
